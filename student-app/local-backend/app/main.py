...
from app.api.v1 import chat, packages, feedback, offline_logs, learning_package
...
app.include_router(learning_package.router, prefix="/api/v1")
...
async def health():
    ...
    return {
        "status": "ok",
        "ok": True,  # Add 'ok' field for frontend compatibility
